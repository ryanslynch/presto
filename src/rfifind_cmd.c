...
void usage(void)
{
    fputs("   [-ncpus ncpus] -o outfile [-filterbank] [-psrfits] [-noweights] [-noscales] [-nooffsets] [-wapp] [-window] [-numwapps numwapps] [-if ifs] [-clip clip] [-noclip] [-invert] [-zerodm] [-xwin] [-nocompute] [-rfixwin] [-rfips] [-time time] [-blocks blocks] [-timesig timesigma] [-freqsig freqsigma] [-chanfrac chantrigfrac] [-intfrac inttrigfrac] [-zapchan zapchanstr] [-zapints zapintsstr] [-mask maskfile] [-ignorechan ignorechanstr] [--] infile ...\n", stderr);
    fputs("      Examines radio data for narrow and wide band interference as well as problems with channels\n", stderr);
    ...
    fputs("          -xwin: Draw plots to the screen as well as a PS file\n", stderr);
    fputs("     -nocompute: Just plot and remake the mask\n", stderr);
    fputs("       -rfixwin: Show the RFI instances on screen\n", stderr);
    fputs("         -rfips: Plot the RFI instances in a PS file\n", stderr);
    fputs("          -time: Seconds to integrate for stats and FFT calcs (use this or -blocks)\n", stderr);
    fputs("                 1 double value between 0 and oo\n", stderr);
    fputs("                 default: `30.0'\n", stderr);
    fputs("        -blocks: Number of blocks (usually 16-1024 samples) to integrate for stats and FFT calcs\n", stderr);
    fputs("                 1 int value between 1 and oo\n", stderr);
    fputs("       -timesig: The +/-sigma cutoff to reject time-domain chunks\n", stderr);
    fputs("                 1 float value between 0 and oo\n", stderr);
    fputs("                 default: `10'\n", stderr);
    fputs("       -freqsig: The +/-sigma cutoff to reject freq-domain chunks\n", stderr);
    fputs("                 1 float value between 0 and oo\n", stderr);
    fputs("                 default: `4'\n", stderr);
    fputs("      -chanfrac: The fraction of bad channels that will mask a full interval\n", stderr);
    fputs("                 1 float value between 0.0 and 1.0\n", stderr);
    fputs("                 default: `0.7'\n", stderr);
    fputs("       -intfrac: The fraction of bad intervals that will mask a full channel\n", stderr);
    fputs("                 1 float value between 0.0 and 1.0\n", stderr);
    fputs("                 default: `0.3'\n", stderr);
    fputs("       -zapchan: Comma separated string (no spaces!) of channels to explicitly mask.  Ranges are specified by min:max[:step]\n", stderr);
    fputs("                 1 char* value\n", stderr);
    fputs("       -zapints: Comma separated string (no spaces!) of intervals to explicitly mask.  Ranges are specified by min:max[:step]\n", stderr);
    fputs("                 1 char* value\n", stderr);
    ...
    fputs("                 1 char* value\n", stderr);
    fputs("         infile: Input data file name(s).\n", stderr);
