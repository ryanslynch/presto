...
void usage(void)
{
    fputs("   [-ncpus ncpus] -o outfile [-filterbank] [-psrfits] [-noweights] [-noscales] [-nooffsets] [-window] [-if ifs] [-clip clip] [-noclip] [-invert] [-zerodm] [-nobary] [-shorts] [-numout numout] [-downsamp downsamp] [-offset offset] [-start start] [-dm dm] [-mask maskfile] [-ignorechan ignorechanstr] [--] infile ...\n", stderr);
    fputs("      Prepares a raw data file for pulsar searching or folding (conversion, de-dispersion, and barycentering).\n", stderr);
    ...
    fputs("        -shorts: Use short ints for the output data instead of floats\n", stderr);
    ...
    fputs("                 default: `0.0'\n", stderr);
    fputs("            -dm: The dispersion measure to de-disperse (cm^-3 pc)\n", stderr);
