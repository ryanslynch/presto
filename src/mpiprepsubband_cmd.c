...
void usage(void)
{
    fputs("   -o outfile [-filterbank] [-psrfits] [-noweights] [-noscales] [-nooffsets] [-wapp] [-window] [-numwapps numwapps] [-if ifs] [-clip clip] [-noclip] [-invert] [-zerodm] [-runavg] [-numout numout] [-nobary] [-offset offset] [-start start] [-lodm lodm] [-dmstep dmstep] [-numdms numdms] [-nsub nsub] [-downsamp downsamp] [-mask maskfile] [-ignorechan ignorechanstr] [--] infile ...\n", stderr);
    ...
    fputs("                 1 int value between 1 and 128000\n", stderr);
    fputs("                 default: `10'\n", stderr);
