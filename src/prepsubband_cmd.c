...
void usage(void)
{
    fputs("   [-ncpus ncpus] -o outfile [-filterbank] [-psrfits] [-noweights] [-noscales] [-nooffsets] [-wapp] [-window] [-numwapps numwapps] [-if ifs] [-clip clip] [-noclip] [-invert] [-zerodm] [-runavg] [-sub] [-subdm subdm] [-numout numout] [-nobary] [-offset offset] [-start start] [-lodm lodm] [-dmstep dmstep] [-numdms numdms] [-nsub nsub] [-downsamp downsamp] [-dmprec dmprec] [-mask maskfile] [-ignorechan ignorechanstr] [--] infile ...\n", stderr);
    fputs("      Converts a raw radio data file into many de-dispersed time-series (including barycentering).\n", stderr);
    ...
    fputs("        -runavg: Running mean subtraction from the input data\n", stderr);
    fputs("           -sub: Write subbands instead of de-dispersed data\n", stderr);
    fputs("         -subdm: The DM to use when de-dispersing subbands for -sub\n", stderr);
    fputs("                 1 double value between 0 and 4000.0\n", stderr);
    fputs("                 default: `0.0'\n", stderr);
    fputs("        -numout: Output this many values.  If there are not enough values in the original data file, will pad the output file with the average value\n", stderr);
    fputs("                 1 long value between 1 and oo\n", stderr);
    fputs("        -nobary: Do not barycenter the data\n", stderr);
    fputs("        -offset: Number of spectra to offset into as starting data point\n", stderr);
    fputs("                 1 long value between 0 and oo\n", stderr);
    fputs("                 default: `0'\n", stderr);
    fputs("         -start: Starting point of the processing as a fraction of the full obs\n", stderr);
    fputs("                 1 double value between 0.0 and 1.0\n", stderr);
    fputs("                 default: `0.0'\n", stderr);
    fputs("          -lodm: The lowest dispersion measure to de-disperse (cm^-3 pc)\n", stderr);
    fputs("                 1 double value between 0 and oo\n", stderr);
    fputs("                 default: `0'\n", stderr);
    fputs("        -dmstep: The stepsize in dispersion measure to use(cm^-3 pc)\n", stderr);
    fputs("                 1 double value between 0 and oo\n", stderr);
    fputs("                 default: `1.0'\n", stderr);
    fputs("        -numdms: The number of DMs to de-disperse\n", stderr);
    fputs("                 1 int value between 1 and 10000\n", stderr);
    fputs("                 default: `10'\n", stderr);
    fputs("          -nsub: The number of sub-bands to use\n", stderr);
    fputs("                 1 int value between 1 and 4096\n", stderr);
    fputs("                 default: `32'\n", stderr);
    fputs("      -downsamp: The number of neighboring bins to co-add\n", stderr);
    fputs("                 1 int value between 1 and 128\n", stderr);
    fputs("                 default: `1'\n", stderr);
    fputs("        -dmprec: The number of decimals in the precision of the DM in the filename.\n", stderr);
    fputs("                 1 int value between 2 and 4\n", stderr);
    fputs("                 default: `2'\n", stderr);
