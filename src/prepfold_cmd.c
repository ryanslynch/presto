...
void usage(void)
{
    ...
    fputs("                  1 int value between 1 and 8\n", stderr);
    fputs("                  default: `1'\n", stderr);
    fputs("             -if: A specific IF to use if available (summed IFs is the default)\n", stderr);
    fputs("                  1 int value between 0 and 1\n", stderr);
    fputs("           -clip: Time-domain sigma to use for clipping (0.0 = no clipping, 6.0 = default\n", stderr);
    fputs("                  1 float value between 0 and 1000.0\n", stderr);
    fputs("                  default: `6.0'\n", stderr);
    fputs("         -noclip: Do not clip the data.  (The default is to _always_ clip!)\n", stderr);
    fputs("         -noxwin: Do not show the result plots on-screen, only make postscript files\n", stderr);
    fputs("         -runavg: Subtract each blocks average as it is read (single channel data only)\n", stderr);
    fputs("           -fine: A finer gridding in the p/pdot plane (for well known p and pdot)\n", stderr);
    fputs("         -coarse: A coarser gridding in the p/pdot plane (for uknown p and pdot)\n", stderr);
    fputs("           -slow: Sets useful flags for slow pulsars\n", stderr);
    fputs("      -searchpdd: Search p-dotdots as well as p and p-dots\n", stderr);
    fputs("      -searchfdd: Search f-dotdots as well as f and f-dots\n", stderr);
    fputs("       -nosearch: Show but do not search the p/pdot and/or DM phase spaces\n", stderr);
    fputs("      -nopsearch: Show but do not search over period\n", stderr);
    fputs("     -nopdsearch: Show but do not search over p-dot\n", stderr);
    fputs("     -nodmsearch: Show but do not search over DM\n", stderr);
    ...
    fputs("             -dm: The central DM of the search (cm^-3 pc)\n", stderr);
    fputs("                  1 double value between 0 and oo\n", stderr);
    fputs("                  default: `0'\n", stderr);
    fputs("              -n: The number of bins in the profile.  Defaults to the number of sampling bins which correspond to one folded period\n", stderr);
    fputs("                  1 int value\n", stderr);
    fputs("           -nsub: The number of sub-bands to use for the DM search.  If unspecified, will use something reasonable.\n", stderr);
    fputs("                  1 int value between 1 and 4096\n", stderr);
    fputs("          -npart: The number of sub-integrations to use for the period search\n", stderr);
    fputs("                  1 int value between 1 and 4096\n", stderr);
    fputs("                  default: `64'\n", stderr);
    fputs("          -pstep: The minimum period stepsize over the observation in profile bins\n", stderr);
    fputs("                  1 int value between 1 and 10\n", stderr);
    fputs("                  default: `2'\n", stderr);
    fputs("         -pdstep: The minimum P-dot stepsize over the observation in profile bins\n", stderr);
    fputs("                  1 int value between 1 and 20\n", stderr);
    fputs("                  default: `4'\n", stderr);
    fputs("         -dmstep: The minimum DM stepsize over the observation in profile bins\n", stderr);
    fputs("                  1 int value between 1 and 10\n", stderr);
    fputs("                  default: `2'\n", stderr);
    fputs("         -npfact: 2 * npfact * proflen + 1 periods and p-dots will be searched\n", stderr);
    fputs("                  1 int value between 1 and 10\n", stderr);
    fputs("                  default: `2'\n", stderr);
    fputs("        -ndmfact: 2 * ndmfact * proflen + 1 DMs will be searched\n", stderr);
    fputs("                  1 int value between 1 and 1000\n", stderr);
    fputs("                  default: `3'\n", stderr);
    fputs("              -p: The nominative folding period (s)\n", stderr);
    fputs("                  1 double value between 0 and oo\n", stderr);
    fputs("             -pd: The nominative period derivative (s/s)\n", stderr);
    fputs("                  1 double value\n", stderr);
    fputs("                  default: `0.0'\n", stderr);
    fputs("            -pdd: The nominative period 2nd derivative (s/s^2)\n", stderr);
    fputs("                  1 double value\n", stderr);
    fputs("                  default: `0.0'\n", stderr);
    fputs("              -f: The nominative folding frequency (hz)\n", stderr);
    fputs("                  1 double value between 0 and oo\n", stderr);
    fputs("             -fd: The nominative frequency derivative (hz/s)\n", stderr);
    fputs("                  1 double value\n", stderr);
    fputs("                  default: `0'\n", stderr);
    fputs("            -fdd: The nominative frequency 2nd derivative (hz/s^2)\n", stderr);
    fputs("                  1 double value\n", stderr);
    fputs("                  default: `0'\n", stderr);
    fputs("          -pfact: A factor to multiple the candidate p and p-dot by\n", stderr);
    fputs("                  1 double value between 0.0 and 100.0\n", stderr);
    fputs("                  default: `1.0'\n", stderr);
    fputs("          -ffact: A factor to multiple the candidate f and f-dot by\n", stderr);
    fputs("                  1 double value between 0.0 and 100.0\n", stderr);
    fputs("                  default: `1.0'\n", stderr);
    fputs("            -phs: Offset phase for the profil\n", stderr);
    fputs("                  1 double value between 0.0 and 1.0\n", stderr);
    fputs("                  default: `0.0'\n", stderr);
    fputs("          -start: The folding start time as a fraction of the full obs\n", stderr);
    fputs("                  1 double value between 0.0 and 1.0\n", stderr);
    fputs("                  default: `0.0'\n", stderr);
    fputs("            -end: The folding end time as a fraction of the full obs\n", stderr);
    fputs("                  1 double value between 0.0 and 1.0\n", stderr);
    fputs("                  default: `1.0'\n", stderr);
    fputs("            -psr: Name of pulsar to fold (do not include J or B)\n", stderr);
    fputs("                  1 char* value\n", stderr);
    fputs("            -par: Name of a TEMPO par file from which to get PSR params\n", stderr);
    fputs("                  1 char* value\n", stderr);
    fputs("        -polycos: File containing TEMPO polycos for psrname (not required)\n", stderr);
    fputs("                  1 char* value\n", stderr);
    fputs("         -timing: Sets useful flags for TOA generation. Generates polycos (if required) based on the par file specified as the argument. (This means you don't need the -par or -psr commands!)\n", stderr);
    fputs("                  1 char* value\n", stderr);
    fputs("        -rzwcand: The candidate number to fold from 'infile'_rzw.cand\n", stderr);
    fputs("                  1 int value between 1 and oo\n", stderr);
    fputs("        -rzwfile: Name of the rzw search '.cand' file to use (with suffix)\n", stderr);
    fputs("                  1 char* value\n", stderr);
    fputs("      -accelcand: The candidate number to fold from 'infile'_rzw.cand\n", stderr);
    fputs("                  1 int value between 1 and oo\n", stderr);
    fputs("      -accelfile: Name of the accel search '.cand' file to use (with suffix)\n", stderr);
    fputs("                  1 char* value\n", stderr);
    fputs("            -bin: Fold a binary pulsar.  Must include all of the following parameters\n", stderr);
    ...
    fputs("                  1 double value\n", stderr);
    fputs("                  default: `0'\n", stderr);
    fputs("           -mask: File containing masking information to use\n", stderr);
    fputs("                  1 char* value\n", stderr);
    fputs("     -ignorechan: Comma separated string (no spaces!) of channels to ignore (or file containing such string).  Ranges are specified by min:max[:step]\n", stderr);
    fputs("                  1 char* value\n", stderr);
    fputs("         -events: Use a event file instead of a time series (.dat) file\n", stderr);
    fputs("           -days: Events are in days since the EPOCH in the '.inf' file (default is seconds)\n", stderr);
    fputs("           -mjds: Events are in MJDs\n", stderr);
    fputs("         -double: Events are in binary double precision (default is ASCII)\n", stderr);
    fputs("         -offset: A time offset to add to the 1st event in the same units as the events\n", stderr);
    fputs("                  1 double value\n", stderr);
    fputs("                  default: `0'\n", stderr);
