...
def main(fil_filenm, workdir):
    ...
    for psfile in psfiles:
        ...
        if "singlepulse" in psfile:
            ...
            # Original: os.system("pstoimg -density 100 -crop a "+epsfile)
            os.system("gs -q -dSAFER -dBATCH -dNOPAUSE -sDEVICE=png16m -r100 "
            ...
            # Original: os.system("pstoimg -density 100 -flip cw "+psfile)
            os.system("gs -q -dSAFER -dBATCH -dNOPAUSE -sDEVICE=png16m -r100 "
